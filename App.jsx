...
function AppointmentTypeStep({ booking, updateBooking, onNext, onAppointmentTypeChange }) {
  ...
  // "Visit LG CUT" does NOT go through the online booking flow. The company
  // wants walk-in customers to message the barber on WhatsApp so he can confirm
  // his availability directly. Clicking opens WhatsApp with a pre-filled
  // message; the customer just hits send and it lands in the barber's chat.
  const visitWhatsAppLink = `https://wa.me/${businessConfig.whatsappNumber.replace(/^0/, "234")}?text=${encodeURIComponent(
    "Hello LG CUT! I'd like to visit your barbershop. Are you available?"
  )}`;
  ...
  const canProceed = booking.appointmentType === "home";
    ...
    <div className="appointment-type" ref={stepRef}>
      <div className="appointment-type__options">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="appointment-type__option appointment-type__option--link"
        >
          ...
          <span className="appointment-type__body">
            ...
            <span className="appointment-type__desc">Message us on WhatsApp to check availability</span>
          </span>
            ...
            <div className={`service-area-check ${serviceAreaStatus.available ? "service-area-check__available" : "service-area-check__unavailable"}`}>
              ...
              {!serviceAreaStatus.available && (
                <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", marginTop: "1rem" }}>
                  <a
                    className="btn btn--ghost btn--small"
                    href={`https://wa.me/${businessConfig.whatsappNumber.replace(/^0/, "234")}?text=${encodeURIComponent(
                      "Hello LG CUT! I'd like to visit your barbershop. Are you available?"
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
